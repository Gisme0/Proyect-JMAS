                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="Cod_postal" placeholder="Codigo postal">
                                    <input type="text" class="form-control mb-3" name="Correo" placeholder="Correo electronico">
                                    <input type="text" class="form-control mb-3" name="NumTel" placeholder="Numero de Telefono">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php  echo $row['Cod_postal']?></th>
                                                <th><?php  echo $row['Correo']?></th>
                                                <th><?php  echo $row['NumTel']?></th>
